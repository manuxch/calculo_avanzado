...
\begin{frame}{Motivación}
	...
	\begin{columns}[c]
		...
		\begin{itemize}
			...
			\item \textbf{Mecánica de sólidos:} direcciones y esfuerzos principales.
			\item \textbf{Dinámica rotacional:} ejes principales de inercia.
			...
			\item \textbf{Control automático:} determinación de la estabilidad de un sistema.
		\end{itemize}
		...
		\begin{center}
			\begin{tikzpicture}[
					...
					mass/.style={draw, thick, minimum width=0.5cm, minimum height=0.85cm, fill=gray!10},
					spring/.style={decorate, decoration={coil, segment length=2pt, amplitude=3pt, pre length=2pt, post length=2pt}, thick},
		...
		\raggedleft {\small  $\mapsto$ Ver ejercicio 13 de la práctica 7.}
	\end{columns}
