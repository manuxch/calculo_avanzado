...
\begin{question} % Armadura - ejemplo de motivación, unidad 8
	Se desea analizar la armadura estáticamente determinada de la figura, con nudos
	...
	cada uno de los 4 nudos se obtienen 8 ecuaciones lineales para las 8 incógnitas
	...
	\begin{enumerate}[a)]
		\item Plantee las ecuaciones de equilibrio en los cuatro nudos ($A$, $B$, $C$ y
