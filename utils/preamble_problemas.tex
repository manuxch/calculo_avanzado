...
\setmonofont[Scale=0.90]{Hack Nerd Font Mono}
\usepackage{hyperref}
\hypersetup{
...
%% Tikz
\usepackage{tikz}
\usetikzlibrary{shapes,shadows,arrows,arrows.meta,positioning,matrix,chains,backgrounds,fit,decorations.pathmorphing,calc}
