...
\date{{\tiny \texttt{Departamento de Ingeniería Mecánica \\[-0.5em]
				Centro de Investigación en Mecánica Experimental y Computacional \\[-0.5em]
...
\institute{
	...
	\centering
	{\tiny
		Cálculo Avanzado \enspace • \enspace 2026 \\
